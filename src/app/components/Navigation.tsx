...
export function Navigation({ isDark, toggleDark }: NavigationProps) {
  ...
  const navItemVariants = {
    ...
    visible: { 
      y: 0, 
      opacity: 1, 
      transition: { type: "spring", stiffness: 70, damping: 20, mass: 1 } as any
    }
  };
  ...
  return (
    <>
      <motion.nav
        ...
        style={{
          background: isDark ? 'rgba(8, 8, 12, 0.88)' : 'rgba(255, 255, 255, 0.88)',
          ...
          >
            <div className="flex flex-col items-center gap-10 w-full max-w-xs">
              ...
              <motion.button
                ...
                onClick={() => handleNavClick({ label: 'Contact', type: 'scroll' as const, id: 'contact' })}
